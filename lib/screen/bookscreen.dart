...
class _Salon_screenState extends State<Salon_screen> {
  Future<void> getslot() async {
    var res = await http.post(Uri.parse(url_timeslot), body: {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const Time_Slot(),
      ),
    );
  }
            ...
            Material(
              ...
              child: SizedBox(
                ...
                child: Image(
                  fit: BoxFit.fitWidth,
                  image: NetworkImage(
                    uploaded_images + Salon_image[card_position]['image_name'],
                  ),
                ),
              ),
            ),
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        Salon_image[card_position]['Name'],
                      ...
                      Text(
                        Salon_image[card_position]['address'],
                        textAlign: TextAlign.center,
                        style: GoogleFonts.ubuntu(
                          fontSize: 20.0,
                      ...
                      const SizedBox(height: 12.0),
                      Text(
                        Salon_image[card_position]['number'],
                        textAlign: TextAlign.center,
                        style: GoogleFonts.ubuntu(
                          fontSize: 18.0,
                        ),
